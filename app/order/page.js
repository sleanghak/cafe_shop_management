...
import { CSMCreateOrder, CSMEditOrder } from './../../components/organisms/dialogs';
import { CSMTableOrder } from './../../components/organisms/table';
...
const Order = () => {
    ...
    const { data, error } = useSWR("http://localhost:3000/api/table_order", fetcher);
                                        ...
                                        return (
                                            <Box key={index}>
                                                <CSMTableOrder
                                                    ...
                                                    date={item.date}
                                                    onDelete={() => handleDelete(item.or_id)}
                                                />
                                            </Box>
                                        );
                                    })}
