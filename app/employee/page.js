...
import { CSMCreateEmployee, CSMEditEmployee } from './../../components/organisms/dialogs';
import { CSMTableEmployee } from './../../components/organisms/table';
                                        ...
                                        return (
                                            <Box key={index}>
                                                <CSMTableEmployee
                                                    ...
                                                    onDelete={() => handleDelete(item.emp_id)}
                                                />
                                            </Box>
                                        );
                                    })}
